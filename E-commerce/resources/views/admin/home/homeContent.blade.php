                    ...
                    <div class="header-section">
                        ...
                        <div class="top_menu">
                            <div class="main-search">
                                ...
                                <div class="close"><img src="{{asset('public/userFrontEnd/')}/cross.png" /></div>
                            </div>
                                ...
                                <ul class="nofitications-dropdown">
                                    ...
                                    <li class="dropdown note">
                                        ...
                                        <ul class="dropdown-menu two first">
                                            ...
                                            <li><a href="#">
                                                    <div class="user_img"><img src="{{asset('public/userFrontEnd/')}/1.jpg" alt=""></div>
                                            ...
                                            <li class="odd"><a href="#">
                                                    <div class="user_img"><img src="{{asset('public/userFrontEnd/')}/in.jpg" alt=""></div>
                                                    <div class="notification_desc">
                                                        <p>Lorem ipsum dolor sit amet </p>
                                                        <p><span>1 hour ago</span></p>
                                                    </div>
                                            ...
                                            <li><a href="#">
                                                    <div class="user_img"><img src="{{asset('public/userFrontEnd/')}/in1.jpg" alt=""></div>
                                                    <div class="notification_desc">
                                                        <p>Lorem ipsum dolor sit amet </p>
                                                        <p><span>1 hour ago</span></p>
                                                    </div>
                                    ...
                                    <li class="dropdown note">
                                        ...
                                        <ul class="dropdown-menu two">
                                            ...
                                            <li class="odd"><a href="#">
                                                    <div class="user_img"><img src="{{asset('public/userFrontEnd/')}/in5.jpg" alt=""></div>
                                                    <div class="notification_desc">
                                                        <p>Lorem ipsum dolor sit amet </p>
                                                        <p><span>1 hour ago</span></p>
                                                    </div>
                                            ...
                                            <li><a href="#">
                                                    <div class="user_img"><img src="{{asset('public/userFrontEnd/')}/in8.jpg" alt=""></div>
                                                    <div class="notification_desc">
                                                        <p>Lorem ipsum dolor sit amet </p>
                                                        <p><span>1 hour ago</span></p>
                                                    </div>
                                        ...
                                        <div class="profile-nav alt">
                                            <section class="panel">
                                                ...
                                                <ul class="clock-category">
                                                    <li>
                                                        <a href="#" class="active">
                                                            <img src="{{asset('public/userFrontEnd/')}/time.png" alt="">
                                                            <span>Clock</span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="#">
                                                            <img src="{{asset('public/userFrontEnd/')}/alarm.png" alt="">
                                                            <span>Alarm</span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="#">
                                                            <img src="{{asset('public/userFrontEnd/')}/watch.png" alt="">
                                                            <span>Stop watch</span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="#">
                                                            <img src="{{asset('public/userFrontEnd/')}/timer.png" alt="">
                                                            <span>Timer</span>
                                                        </a>
                                                    </li>
                                                </ul>
