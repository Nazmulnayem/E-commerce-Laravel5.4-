            ...
            <div class="error-top">
                ...
                <div class="login">
                   ...
                   {!!Form::open(['url'=>'/login','method'=>'POST'])!!}
                          ...
                          <input type="email" name="email" class="text" value="E-mail address" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'E-mail address';}" >
                        <input type="password" name="password" value="Password" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Password';}">
                        <div class="submit"><input type="submit" onclick="myFunction()" name="btn" value="Login" ></div>
                        <div class="clearfix"></div>
