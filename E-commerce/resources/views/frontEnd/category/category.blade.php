	...
	<div class="container">
			...
			<div class="filter-price">
				<h3>Filter By Price</h3>
					<ul class="dropdown-menu6">
						...
						<script type="text/javascript" src="{{asset('frontEnd/js2/jquery-ui.js')}}"></script>
					 <!---->
			</div>
		...
		<div class="col-md-8 products-right">
			...
			<div class="men-wear-top">
				<script src="{{asset('frontEnd/js2/responsiveslides.min.js')}}"></script>
				<script>
				...
				<div  id="top" class="callbacks_container">
					<ul class="rslides" id="slider3">
						<li>
							<img class="img-responsive" src="{{asset('frontEnd/images2/men1.jpg')}}" alt=" "/>
						</li>
						<li>
							<img class="img-responsive" src="{{asset('frontEnd/images2/men2.jpg')}}" alt=" "/>
						</li>
						<li>
							<img class="img-responsive" src="{{asset('frontEnd/images2/men1.jpg')}}" alt=" "/>
						</li>
			...
			<div class="men-wear-bottom">
				<div class="col-sm-4 men-wear-left">
					<img class="img-responsive" src="{{asset('frontEnd/images2/men3.jpg')}}" alt=" " />
				</div>
							...
							<img src="{{asset('frontEnd/images2/ep2.png')}}" alt="" class="pro-image-back">
										<div class="men-cart-pro">
											<div class="inner-men-cart-pro">
												<a href="{{url('/productDetails')}}" class="link-product-add-cart">Quick View</a>
											</div>
										</div>
				...
				<div class="col-md-4 product-men no-pad-men">
					<div class="men-pro-item simpleCart_shelfItem">
						<div class="men-thumb-item">
							<img src="{{asset('frontEnd/images2/a2.png')}}" alt="" class="pro-image-front">
							<img src="{{asset('frontEnd/images2/a2.png')}}" alt="" class="pro-image-back">
										<div class="men-cart-pro">
											<div class="inner-men-cart-pro">
